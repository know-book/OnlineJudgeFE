export const m = {
  ...
  Proctor_Title: '本次考试必须共享整个屏幕',
  Proctor_Intro: '在题目显示之前，你必须共享「整个屏幕」。只共享单个窗口或单个浏览器标签页不予受理。',
  Proctor_Check_Notice: '系统会检查你实际共享的画面：确认共享的是整个屏幕，而不是窗口或标签页，并在考试期间持续检查。角落的预览就是当前被捕获的画面。',
  Proctor_Enforcement: '一旦你停止共享，或改为只共享窗口或标签页，考试界面会立即锁定，必须重新共享整个屏幕才能继续。',
  Proctor_Rules_Notice: '考试期间停止或限制屏幕共享，视同违反考试规则。',
  Proctor_Share_Button: '共享整个屏幕',
  Proctor_Retry_Button: '重新共享',
  Proctor_Loading: '正在加载考试...',
  Proctor_Wrong_Surface: '你共享的是窗口或浏览器标签页，不是整个屏幕。请重新共享，并在选择界面中选取「整个屏幕」。',
  Proctor_Denied: '你取消了屏幕共享。必须共享整个屏幕才能参加考试。',
  Proctor_Error: '无法开始屏幕共享。请确认浏览器已获得屏幕录制权限后再试一次。',
  Proctor_macOS_Hint: 'macOS 请到「系统设置 > 隐私与安全性 > 屏幕录制」中允许你的浏览器，然后重新打开浏览器。',
  Proctor_Stopped_Title: '屏幕共享已中止',
  Proctor_Stopped_Body: '考试已锁定。请重新共享整个屏幕以继续答题。',
  Proctor_Unsupported_Title: '此浏览器无法参加考试',
  Proctor_Unsupported_Body: '本次考试必须共享整个屏幕，手机和平板的浏览器不支持该功能。请改用台式机或笔记本上的 Chrome 或 Edge。',
  Proctor_Unverifiable_Body: '这个浏览器无法让系统确认你共享的是整个屏幕。本次考试请使用台式机或笔记本上的 Chrome 或 Edge。',
  Proctor_Insecure_Body: '此页面必须通过 HTTPS 提供，才能启动屏幕共享。',
  Proctor_Multi_Display: '检测到一个以上的显示器。请先断开多余的显示器再开始答题。',
  Proctor_Monitor_Title: '共享中',
  Proctor_Monitor_Paused: '捕获已暂停',
  Proctor_Monitor_Collapse: '收起',
  Proctor_Monitor_Expand: '展开',
  // ContestList.vue
  Rule: '赛制',
  OI: 'OI',
  ACM: 'ACM',
  ...
  UserLogin: '登录',
  LoginWithAuthentik: '使用 Authentik 登录',
  OIDCLoginFailed: 'Authentik 登录失败，请稍后再试。',
  Welcome_back: '欢迎回来',
  // OIRank.vue
  OI_Ranklist: 'OI 排名',
  // OIContestRank.vue
