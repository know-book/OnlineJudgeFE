export const m = {
  ...
  Sample_Output: '輸出範例',
  Hint: '提示',
  Reading_Materials: '指定閱覽教材',
  Download_Material: '下載',
  Source: '題目來源',
  Status: '狀態',
  Information: '題目資訊',
  Time_Limit: '時間限制',
  ...
  Proctor_Title: '本次考試必須分享整個螢幕',
  Proctor_Intro: '在題目顯示之前，你必須分享「整個螢幕」。只分享單一視窗或單一瀏覽器分頁不予受理。',
  Proctor_Check_Notice: '系統會檢查你實際分享的畫面：確認分享的是整個螢幕，而不是視窗或分頁，並且在考試期間持續檢查。角落的預覽就是目前被擷取的畫面。',
  Proctor_Enforcement: '一旦你停止分享，或改為只分享視窗或分頁，考試畫面會立即鎖住，必須重新分享整個螢幕才能繼續。',
  Proctor_Rules_Notice: '考試期間停止或限縮螢幕分享，視同違反考試規則。',
  Proctor_Share_Button: '分享整個螢幕',
  Proctor_Retry_Button: '重新分享',
  Proctor_Loading: '正在載入考試...',
  Proctor_Wrong_Surface: '你分享的是視窗或瀏覽器分頁，不是整個螢幕。請重新分享，並在選擇畫面中選取「整個畫面」。',
  Proctor_Denied: '你取消了螢幕分享。必須分享整個螢幕才能進行考試。',
  Proctor_Error: '無法開始螢幕分享。請確認瀏覽器已取得螢幕錄製權限後再試一次。',
  Proctor_macOS_Hint: 'macOS 請到「系統設定 > 隱私權與安全性 > 螢幕錄製」中允許你的瀏覽器，然後重新開啟瀏覽器。',
  Proctor_Stopped_Title: '螢幕分享已中止',
  Proctor_Stopped_Body: '考試已鎖住。請重新分享整個螢幕以繼續作答。',
  Proctor_Unsupported_Title: '此瀏覽器無法進行考試',
  Proctor_Unsupported_Body: '本次考試必須分享整個螢幕，手機與平板的瀏覽器不支援這項功能。請改用桌機或筆電上的 Chrome 或 Edge。',
  Proctor_Unverifiable_Body: '這個瀏覽器無法讓系統確認你分享的是整個螢幕。本次考試請使用桌機或筆電上的 Chrome 或 Edge。',
  Proctor_Insecure_Body: '此頁面必須透過 HTTPS 提供，才能啟動螢幕分享。',
  Proctor_Multi_Display: '偵測到一個以上的顯示器。請先移除多餘的顯示器再開始作答。',
  Proctor_Monitor_Title: '分享中',
  Proctor_Monitor_Paused: '擷取已暫停',
  Proctor_Monitor_Collapse: '收合',
  Proctor_Monitor_Expand: '展開',
  // ContestList.vue
  Rule: '賽制',
  OI: 'OI',
  ACM: 'ACM',
